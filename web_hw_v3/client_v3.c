    ...
    while(1)
    {
        ...
        switch (instruction)
        {
            ...
            case 10: {
                ...
                int wanter;
                sscanf(recvbuf,"10 %d\n",&wanter);
                sprintf(sendbuf, "11 %d %d %d %d %d %d %d %d %d %d\n",wanter, board[0], \
                board[1],board[2],board[3],board[4],board[5],board[6],board[7],board[8]);
            ...
            case 12: {
                int apple[9];
                sscanf (recvbuf,"%d %d%d%d%d%d%d%d%d%d",&instruction, \
                    &apple[0],&apple[1],&apple[2],&apple[3],&apple[4],&apple[5],&apple[6], \
                        &apple[7],&apple[8]);
                printf ("Watching-------------------------------\n");
                print_board(apple);
                printf ("End of Watching------------------------\n");
                break;
            }
